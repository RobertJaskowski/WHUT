                ...
                if (isOdd)
                {
                    ...
                    switch (commandData[0])
                    {
                        ...
                        case "w":
                            ...
                            segment.autoDelay = float.Parse(commandData[1], CultureInfo.InvariantCulture);//CultureInfo.InvariantCulture
                            break;
                        case "wa":
                            segment.trigger = SEGMENT.TRIGGER.autoDelay;
                            segment.autoDelay = float.Parse(commandData[1], CultureInfo.InvariantCulture);
                            segment.pretext = segments.Count > 0 ? segments[segments.Count - 1].dialogue : "";
